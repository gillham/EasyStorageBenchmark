...
%option merge
    ...
    ; UI colors
    const ubyte COLOR_BORDER = platform.COLOR_BLACK
    const ubyte COLOR_SCREEN = platform.COLOR_BLUE
    const ubyte COLOR_TEXT = platform.COLOR_WHITE
    const ubyte COLOR_TITLE = platform.COLOR_LIGHT_GREEN
    const ubyte COLOR_DRIVE = platform.COLOR_YELLOW
    const ubyte COLOR_KEYS = platform.COLOR_LIGHT_GRAY
    const ubyte COLOR_MENU = platform.COLOR_TEXT
    const ubyte COLOR_RESULTS = platform.COLOR_CYAN
